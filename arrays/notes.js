...
notes.forEach(function (item, index) {
  // Callback function is a function that gets passed to sa function
...
for (let count = 2; count >= 0; count--) {
  // When I use forEach I have to have an array and count from beginning to end. When I use for statement I have more flexibility, as seen below.
  console.log(count);
}

for (let count = notes.length - 1; count >= 0; count--) {
  // Count is locally scoped to the for statement, if I try to access count outside of this scope it will not work
